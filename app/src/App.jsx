...
const PAGES = [
  { id: "qdii", nav: "纳指 · QDII", title: "纳指 · QDII", El: lazy(() => import("./pages/QdiiPage")) },
  { id: "etf", nav: "159696走势", title: "159696 走势", El: lazy(() => import("./pages/EtfPage")) },
  { id: "us", nav: "美股纳指100", title: "美股纳指100", El: lazy(() => import("./pages/UsPage")) },
  { id: "median", nav: "A股中位数", title: "A股中位数", El: lazy(() => import("./pages/MedianPage")) },
  { id: "index", nav: "A股宽基指数", title: "A股宽基指数", El: lazy(() => import("./pages/IndexPage")) },
