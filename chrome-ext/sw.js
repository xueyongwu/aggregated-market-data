...
// pct = 实时价/base - 1。同 EtfPage 里半程点的算法。
// 不移植 EtfPage 的 nqRebase(): CI 15:10(北京) 那趟已把新窗口写进 nq_data.js,
// 而 alarm 粒度 1 分钟, 抢不到那 10 分钟。
const NQ_DATA = "https://raw.githubusercontent.com/xueyongwu/aggregated-market-data/main/app/src/data/nq_data.js";
...
const PAGE = "https://xueyongwu.github.io/aggregated-market-data/#/etf";
const UP = "#e4534a", DOWN = "#16b070", FLAT = "#8a8a8a";  // A股惯例: 涨红跌绿, 同 app/src/theme.css

// 两个接口都不是纯 JSON: 一个是 "export const NQ_OVERNIGHT = {...};",
